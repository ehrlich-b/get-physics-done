...
**Last Activity Description:** v15.0 'The P5 <-> Basin Restriction Lemma' COMPLETE & ARCHIVED 2026-05-24 via /gpd:complete-milestone. Verdict (DERV-00-02) = CHARACTERIZED OBSTRUCTION refining RESTRICTION to coexistence-as-island (the self-modeling -> QM -> h_3(O) through-line SURVIVES; NOT independent posits, NOT a program collapse). Archived ROADMAP + REQUIREMENTS (SHIPPED header) + RESEARCH-DIGEST; MILESTONES.md v15.0 entry; ROADMAP collapsed to a <details> block; REQUIREMENTS.md retired; PROJECT.md evolved; git tag v15.0. v14.0 remains PAUSED pending JMP referee report.
