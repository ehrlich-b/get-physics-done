...
| **claim-matter-sourcing** — slice curvature sourced by M in V_1+V_{1/2} via cubic-norm cross-terms (CONDITIONAL on Phase 71 surviving) | Phase 72 (B) | test-cross-term-onoff, test-lambda-vs-matter | **UNBLOCKED by Phase 70.1 (2026-05-31)** — η+h selected ⇒ re-scope Phase 72 to MATTER-ON-FLAT (M=0 baseline flat KKT η; matter sources h via the det₃ cross-term; cross-term ON/OFF + Λ-vs-matter as originally framed). Needs re-plan. |
...
- [ ] **Phase 72: B — Matter-Sourcing (CONDITIONAL on Phase 71)** — **UNBLOCKED 2026-05-31 by Phase 70.1 (η+h selected). RE-SCOPE to MATTER-ON-FLAT (needs re-plan):** the M=0 baseline is flat KKT Minkowski (η); matter in V_1/V_{1/2} sources the perturbation h of g=η+h via the det₃ cross-term 2Re((x₂x₁)x₃); the cross-term ON/OFF (test-cross-term-onoff) and Λ-vs-matter tests apply as originally framed (NO Λ tripwire — flatness is DERIVED from KKT, not inserted). The matter mechanism + ΔR pipeline are PRESERVED. _History: HALTED 2026-05-31 at the 72-01 first-result gate (M=0 cone-Hessian vacuum non-Einstein R_time×H³ {0,-1,-1,-1}) → reopened as Phase 70.1, now resolved. See `.gpd/phases/72-b-matter-sourcing/PHASE-RECOVERY.md`._
...
| 72. B — Matter-Sourcing (conditional) | v17.0 | 0/2 | Unblocked by 70.1 — re-plan as MATTER-ON-FLAT (η+h baseline) | - |
