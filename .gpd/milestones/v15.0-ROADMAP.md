# Research Roadmap: v15.0 The P5 <-> Basin Restriction Lemma (Experiential Measure on Structure Space)
...
<details>
<summary>v6.0 Gap C -- Complexification from C*-Measurement Maps (Phase 22) -- CLOSED 2026-03-24 (negative result)</summary>

- [x] Phase 22: Measurement Maps -- Four Routes to Complexification (4/4 plans) -- completed 2026-03-24
...
<details>
<summary>v7.0 Arrow of Time, Complexification, and Evolutionary Selection (Phases 23-27) -- COMPLETED 2026-03-24 (weakened)</summary>

- [x] Phase 23: Entropy Increase under Sequential Products (2/2 plans) -- completed 2026-03-24
- [x] Phase 24: Chirality Requires Time-Orientation (2/2 plans) -- completed 2026-03-24
- [x] Phase 25: Self-Modeling Requires Free Energy (3/3 plans) -- completed 2026-03-24
- [x] Phase 26: Entropy Gradient Theorem and Gap C (2/2 plans) -- completed 2026-03-24
- [x] Phase 27: Quantitative Predictions (2/2 plans) -- completed 2026-03-24
...
- [x] Phase 28: Peirce Verification and V_0 Channel Exploration (2/2 plans) -- completed 2026-03-29
- [x] Phase 29: Observable Algebra and Representation Theory (2/2 plans) -- completed 2026-03-29
- [x] Phase 30: Impossibility Theorem Formalization (2/2 plans) -- completed 2026-03-29
- [x] Phase 31: Integration (0/2 plans, skipped) -- completed 2026-03-29
...
<details>
<summary>v9.0 Continuum Limit from Finite-Dimensional Observer (Phases 32-36) -- COMPLETED 2026-03-30</summary>

- [x] Phase 32: Fisher Geometry on Reduced States (2/2 plans) -- completed 2026-03-30
- [x] Phase 33: Correlation Structure and Effective Theory (3/3 plans) -- completed 2026-03-30
- [x] Phase 34: Emergent Lorentz Invariance (2/2 plans) -- completed 2026-03-30
- [x] Phase 35: BW Theorem and Local Equilibrium (2/2 plans) -- completed 2026-03-30
- [x] Phase 36: Assembly and Gap Scoring (2/2 plans) -- completed 2026-03-30

See `.gpd/milestones/v9.0-ROADMAP.md` for full details.

</details>

<details>
<summary>v10.0 Universality Class of Self-Modeler Network and Full Gap Closure (Phases 37-41) -- COMPLETED 2026-03-31</summary>

- [x] Phase 37: Gap Dependency Theorem (2/2 plans) -- completed 2026-03-30
- [x] Phase 38: Effective Hamiltonian (2/2 plans) -- completed 2026-03-30
- [x] Phase 39: SSB and Universality Class (4/4 plans) -- completed 2026-03-30
- [x] Phase 40: Assembly -- All Gaps Closed (2/2 plans) -- completed 2026-03-30
- [x] Phase 41: O(9)/S^8 Quantitative Verification (2/2 plans) -- completed 2026-03-30

See `.gpd/milestones/v10.0-ROADMAP.md` for full details.
...
| ------------- | -------------------- | ------ |
| Sequential product identity (i/2)*T_b for 72 pairs | Phase 42 | Planned |
| Theorem: C*-observer complex FC justified on indefinite Peirce operators | Phase 43 | Planned |
| C-linear closure = M_16(C) = Cl(9,C) | Phase 43 | Planned |
| Gap C closure theorem (single statement) | Phase 44 | Planned |
| Paper 7 chain compatibility (L1-L9 no regressions) | Phase 44 | Planned |
| Contingency: obstruction characterization if Phase 43 fails | Phase 45 | Planned (conditional) |

**Key References:**
- Paper 5 (C*-observer, Def 2.6)
- Paper 7 (9-link chain L1-L9)
- v8.0 Phase 30 (three impossibility theorems, T_a matrices)
- Gudder-Greechie (2002) -- sequential product on effects
- Lawson-Michelsohn -- Cl(9,0) tensor_R C = Cl(9,C) = M_16(C) + M_16(C)
...
- [x] **Phase 45: Contingency** -- (conditional: only if Phase 43 fails) NOT NEEDED (Phase 43 succeeded)

## Phase Details

### Phase 42: Computational Verification

**Goal:** The sequential product of indefinite Peirce operators is verified to exit M_16(R) into M_16(C), establishing the computational ground truth that guides all subsequent theoretical work. The effect algebra is verified to stay real as a control.

**Depends on:** Phase 41 (v10.0 T_a matrices from v8.0 Phase 29)
**Requirements:** SEQP-01
**Contract Coverage:**
- Advances: Sequential product identity verification
- Deliverables: Python script with SymPy symbolic + NumPy numerical verification for all 72 off-diagonal pairs, 9 diagonal pairs, and 9 effect-algebra pairs
- Anchor coverage: T_a matrices from v8.0 Phase 29; Cl(9,0) anticommutation {T_a,T_b} = (1/2)*delta_{ab}*I_16; closed-form sqrt(T_a) = ((1+i)I + (1-i)2T_a)/(2*sqrt(2))
- Forbidden proxies: Partial verification (must be ALL 72 pairs); spot-checking a few generators and declaring success

**Success Criteria** (what must be TRUE):

1. sqrt(T_a) T_b sqrt(T_a) = (i/2)*T_b verified for all 72 anticommuting pairs (a != b) to machine precision (< 1e-14 error)
2. sqrt(T_a) T_a sqrt(T_a) = (1/4)*I_16 verified for all 9 diagonal pairs
3. Effect algebra control: E_a & E_b = (1/2)*E_a for all off-diagonal pairs (where E_a = (I + 2T_a)/2), confirming effects stay real
4. The imaginary part of sqrt(T_a) T_b sqrt(T_a) is nonzero for all 72 anticommuting pairs (explicit exit from M_16(R))

**GO/NO-GO gate:** If criterion 1 fails for ANY pair, the sequential product route is dead. STOP and proceed to Phase 45 (Contingency).
...
**Goal:** The physical justification for the observer's complex functional calculus on indefinite Peirce operators is established as a theorem, and the resulting measurement algebra is proved to equal Cl(9,C) = M_16(C) + M_16(C).

**Depends on:** Phase 42 (verified computational results)
**Requirements:** SEQP-02, SEQP-03
**Contract Coverage:**
- Advances: Theorem on complex FC justification; C-linear closure = M_16(C)
- Deliverables: (1) Theorem + proof: C*-observer is justified in applying complex FC to indefinite Peirce operators. (2) Proof that C-linear span of sequential products generates M_16(C). (3) Identification of Cl(9,C) decomposition and S_9 -> S_{10}^+ spinor extension.
- Anchor coverage: Paper 5 Def 2.6 (C*-observer); Gudder-Greechie 2002 (effects only, must be explicitly transcended); van de Wetering 2019 (sequential product -> Jordan); Alfsen-Shultz 1998 (dynamical correspondence, alternative route); v8.0 impossibility theorems (complemented, not circumvented)
- Forbidden proxies: Physical hand-waving without theorem statement; claiming complex FC "just works" without deriving from self-modeling axioms; generating a proper subalgebra of M_16(C) and claiming full closure

**Success Criteria** (what must be TRUE):

1. A theorem is stated and proved: the C*-observer's complex functional calculus on indefinite Peirce operators (eigenvalues +/-1/2, NOT effects) is physically mandated by the self-modeling axioms (Paper 5 Def 2.6) or the observer's C*-structure
2. The C-linear closure of {sqrt(T_a) T_b sqrt(T_a) : a != b} together with Cl(9,0) monomials generates M_16(C), verified by dimension counting: dim_C = 256
3. This algebra is identified as Cl(9,C) via the standard isomorphism Cl(9,0) tensor_R C = Cl(9,C) = M_16(C) + M_16(C), with the even subalgebra Cl^+(9,C) = M_16(C) identified
4. The spinor module extension S_9 -> S_{10}^+ is established: the real 16-dim spinor V_{1/2} = S_9 complexifies to C^16 = S_{10}^+ (positive-chirality Weyl spinor of Spin(10))
5. The proof explicitly addresses why the standard Gudder-Greechie domain restriction to effects [0,I] does not apply here, bridging the gap between effects-only and the observer's full measurement algebra
...
**Goal:** Gap C closure is stated as a single theorem with a complete proof chain, and compatibility with Paper 7's existing 9-link chain is verified with zero regressions.

**Depends on:** Phase 43 (complexification theorem and Cl(9,C) identification)
**Requirements:** GAPC-01, GAPC-02
**Contract Coverage:**
- Advances: Gap C closure theorem; Paper 7 compatibility verification
- Deliverables: (1) Single theorem: C*-observer (Paper 5) -> complex FC on Cl(9,0) generators -> measurement algebra = Cl(9,C) -> spinor module complexifies to S_{10}^+ -> Spin(9) extends to Spin(10) -> F_4 extends to E_6 -> chirality from Cl(6). (2) Gap register update: Gap C status change with equation-level evidence. (3) Link-by-link verification of Paper 7 L1-L9.
- Anchor coverage: Paper 7 L1-L9 chain; v8.0 impossibility theorems (now complemented by observer-induced route); v10.0 gap scorecards (CONDITIONAL-DERIVED -> target: CLOSED or DERIVED)
- Forbidden proxies: Claiming compatibility without checking each of the 9 links; theorem with an unjustified step; overclaiming "algebraic closure" when the result is observer-induced

**Success Criteria** (what must be TRUE):

1. Gap C closure theorem is stated as a single theorem with each step citing a specific theorem/equation number from Phases 42-43 or established literature
2. The proof chain has no logical gaps: each step follows from the previous with explicit justification
3. All 9 existing Paper 7 links (L1-L9) remain valid under the Gap C closure -- verified link by link with explicit compatibility statement
4. The gap register is updated: Gap C status upgraded from CONDITIONAL-DERIVED with precise characterization of what changed and what assumptions remain
5. The result is correctly labeled as "observer-induced complexification" (the v8.0 impossibility theorems are complemented, not contradicted)
...
**Goal:** If Phase 43 fails (complex FC on indefinite operators cannot be physically justified), the precise obstruction is characterized, alternative routes are systematically evaluated, and Gap C status is definitively assessed.

**Depends on:** Phase 43 (triggered ONLY if Phase 43 fails)
**Requirements:** CONT-01, CONT-02
**Contract Coverage:**
- Advances: Obstruction characterization; route evaluation; Gap C ceiling assessment
- Deliverables: (1) Evaluation of Peirce multiplication route and all 4 formal routes (conditional expectations, state-effect, GNS, tensor product) with v11.0 framing from research survey. (2) Precise obstruction statement. (3) Weakest sufficient condition for complexification identified. (4) Gap C status: either "algebraic impossibility confirmed; selection argument (Paper 8) is ceiling" or identification of a viable alternative route.
- Anchor coverage: v6.0 negative result (4 Peirce-mediated routes failed); v7.0 selection argument; v8.0 impossibility theorems; research survey's re-evaluation of all routes with sequential product framing
- Forbidden proxies: Rehashing v6.0 routes without the new sequential product framing; declaring "all routes fail" without exhaustive evaluation of each with the new context

**Success Criteria** (what must be TRUE):

1. Each of the 4 formal routes (conditional expectations, state-effect duality, GNS construction, tensor product) is re-evaluated with the v11.0 sequential product framing and the conclusion is either "viable with additional input X" or "fails because Y"
2. The Peirce multiplication route (distinct from sequential product) is evaluated: does L_{T_a} applied to T_b produce complex operators through any mechanism?
3. The precise obstruction is stated: what mathematical property is missing that would make the complex FC argument work?
4. The weakest sufficient condition for complexification is identified: "If X holds, then Gap C closes via route Y"
5. Gap C final status is stated: either upgraded (with a viable alternative route), or confirmed as "observer-induced selection (Paper 8) is the ceiling of what can be proved"
...
|-------|-----------|---------|:-:|
| 42 - Computational Verification | v10.0 (Phase 41) | 43 | Yes |
| 43 - Complexification Theorem | 42 | 44, 45 (on failure) | Yes |
| 44 - Gap C Assembly | 43 | -- | Yes |
| 45 - Contingency | 43 (failure trigger) | -- | No (conditional) |

**Critical path:** 42 -> 43 -> 44 (3 phases, minimum duration)
**Conditional path:** 42 -> 43 [FAIL] -> 45

## Risk Register

| Phase | Top Risk | Probability | Impact | Mitigation |
|-------|---------|:-:|:-:|-----------|
| 42 | Computation fails (sqrt stays real) | LOW | HIGH | Pre-verified during research; GO/NO-GO kills early |
| 43 | No physical justification for complex FC on indefinite operators | MEDIUM | HIGH | Two independent routes (direct + Alfsen-Shultz); if both fail, Phase 45 contingency |
| 44 | Theorem chain breaks at Spin(10) or E_6 extension step | LOW | MEDIUM | Standard representation theory; isolate break point |
| 45 | All routes fail, no progress beyond v8.0 | MEDIUM | LOW | Honest characterization is still scientific progress; sharpened obstruction |

## Progress

**Execution Order:** 42 -> 43 -> 44 (conditional: 45 only if 43 fails)
...
<details>
<summary>v14.0 Paper 5 Revision -- Close Load-Bearing Jigsaw-Piece Gaps (Phases 54-59) -- PAUSED 2026-04-17 (pending JMP referee report)</summary>

**Status:** PAUSED, resumable. Not failed, not complete. Paper 5 (JMP26-AR-00922, Zenodo DOI 10.5281/zenodo.19342703) is with the JMP associate editor. Resume on (a) referee report received, or (b) explicit user restart. Full inventory + resumption mechanics: `.gpd/V14-CLOSEOUT.md`.

- [x] Phase 54: §3.3 Peirce Preservation from OUS Primitives (3/3 plans) -- sealed (C-i): S0 Peirce-coherence axiom + Peirce-Preservation Lemma integrated to `main.tex`.
- [x] Phase 55: S4 Facial Structure Lemma (3/3 plans) -- sealed (C-i): §S4 revision integrated; A-S cites tightened; SymPy H_3(R)/H_4(R) PASS.
- [x] Phase 56: Thm 5.8 Upper Bound on W (3/3 plans) -- sealed (B): W carries product-form sequential product via vdW 2019 Def. 4 + Thm 1; SPS-morphism corollary.
- [ ] Phase 57: Phi Inert-Wrapper Resolution -- ABANDONED mid-planning (blog commit `a0190df` honest-language fix made it duplicative). Partial plans under `phases/57-phi-inert-wrapper-resolution/abandoned/`.
- [ ] Phase 58: Lean Axiom Audit -- DEFERRED (not started).
- [ ] Phase 59: Minimal Composite Assumption Defense + referee diff -- DEFERRED (not started; depends on referee report).

Full v14.0 phase details, contract overview, pitfalls (R1-R11), and key references are preserved in `.gpd/V14-CLOSEOUT.md` and `.gpd/milestones/v14.0-ROADMAP.md` (when archived).
...
**A clean negative result (a precisely-characterized structural obstruction) is a fully acceptable, valuable outcome. Do NOT force a positive.**

**The attack (4 steps -> 4 phases, Phases 60-63):**

1. **Two-composites distinction** (Phase 60, rigorous + non-circular): the observer's clause-(iii) body-model composite V_BM is a DIFFERENT object from h_3(O)'s BGW Jordan-monoidal non-composability. Non-composability of h_3(O) does NOT entail non-existence of V_BM. The claim is circular/false if these collapse -- the distinction must be EARNED.
2. **Slice satisfies clause (iii)** (Phase 61): verify h_3(C_u) ~ M_3(C)^sa meets all four Def 1 clauses as a self-modeler in its own right (rem:converse supplies (ii)-(iii); check (i), (iv); SymPy validates).
3. **Coherent embedding under E** (Phase 62, the hard part -- where an obstruction would live): show the self-modeling data on A (its V_BM, its sequential product a&b = sqrt(a) b sqrt(a)) is INDUCED by / consistent with the ambient h_3(O) Jordan structure under E -- demonstrated on the ACTUAL non-associative structure, NOT asserted. Preservation proof OR precise obstruction.
4. **Verdict** (Phase 63): a clean RESTRICTION theorem, OR a precisely-characterized obstruction, with the explicit consequence for the program. Adversarial fresh-eyes review of the reward-hacking guards.

**Reward-hacking guard (CENTRAL RISK -- every phase carries a circularity/conflation check):** do NOT "prove" the claim by (1) redefining clause (iii) to be trivially satisfied [fp-redefine-iii]; (2) conflating the observer's body-model composite with the BGW universe-tensoring [fp-conflate-composites]; (3) asserting the Peirce restriction preserves clause (iii) without demonstrating it on the actual non-associative h_3(O) structure [fp-assert-preservation]; or (4) forcing a positive RESTRICTION theorem when the honest outcome is an obstruction [fp-force-positive].

**Pause condition:** the two composites collapse (claim circular), OR the coherent-embedding step needs structure NOT induced by E (obstruction signature requiring imported structure) -> milestone pauses for human decision. A characterized obstruction is a DELIVERABLE, not a pause.

**Deliverable (verdict-only):** `derivations/p5-basin-restriction/` tree -- `claim.md`, `STATE.md`, `attempt-NN.md` (one per serious attempt), `RESULT.md` (theorem-or-obstruction + program consequence), with explicit SymPy/matrix checks on h_3(O) and h_3(C_u). Ready-to-insert Paper 7 LaTeX (rem:converse + lemma + proof) is an outcome-dependent follow-up (FUTR-01), OUT of scope this milestone.

**Sources (LIVE, NOT the stale repo `papers/`):** Paper 5 Def 1 `~/repos/blog/landing/papers/qm-from-self-modeling/main.tex` (def:self-modeling-system line 342); lem:bottleneck `~/repos/blog/landing/papers/sm-from-self-modeling/sections/complexification.tex` (line 409). Inline definitions in `~/scratch/get-physics-done/p5-basin-restriction-prompt.md` are authoritative. rem:converse is prompt-inline; it is NOT yet a labeled remark in the live complexification.tex.
...
- **ref-lem-bottleneck** -- Paper 7 live `complexification.tex` lem:bottleneck (line 409) + rem:converse (prompt-inline): slice A = h_3(C_u) ~ M_3(C)^sa, F_4-orbit of maximal C*-targets, conditional expectation E, rank-1 Peirce-0 = h_2(C_u). [Phases 61, 62]
- **ref-bgw** -- Barnum-Graydon-Wilce 2020 (FRJA composability, Jordan-monoidal): defines the universe-tensoring h_3(O) FAILS; grounds the two-composites distinction and rem:converse (minimal=maximal for M_n(C)^sa). [Phases 60, 62]
- **ref-effros-stormer** -- Effros-Stormer 1979 (positive projections onto JB-subalgebras): underwrites E: h_3(O) -> A; the coherent-embedding step turns on what E preserves (Jordan vs sequential product). [Phase 62]
- **ref-hanche-olsen** -- Hanche-Olsen universal tensor product of Jordan algebras (special vs exceptional): characterizes when Jordan algebras admit well-behaved composites; relevant to whether the slice's composite is induced or imported. [Phases 60, 62]

**Carry-forward prior GPD outputs (bear on the embedding question):**
- **v6.0** (Gap C algebraic -- all 4 routes failed; V_1 = R bottleneck): the Peirce interface to V_{1/2} is scalar; no C*-subalgebra inside h_3(O); observer necessarily external.
- **v8.0** (basin impossibility; observable algebra M_16(R)): basin's Peirce structure alone cannot force complexification.
- **v11.0** (Gap C closure via C*-observer sequential product): C-linear Luders closure extends Cl(9,0) to Cl(9,C); the sequential product a&b = sqrt(a) b sqrt(a) exits M_16(R).
- **Octonion / h_3(O) SymPy infrastructure** from v8.0/v11.0 -- REUSE for VALD-61-01 and VALD-62-01.

**Unresolved context gaps (surfaced; carried into planning):**
- The coherent-embedding step (Phase 62, step 3) is ENTIRELY unproved -- the deepest unproven, load-bearing join in the program, and where any obstruction lives.
- rem:converse is prompt-authoritative but is NOT yet a labeled remark in the live complexification.tex; its exact statement ("minimal = maximal composite for M_n(C)^sa via BGW") must be confirmed against BGW (Phase 60/61).
- Whether E is coherent with the SEQUENTIAL product (not only the Jordan product) is unverified -- non-associativity may leak in (Phase 62).
...
**Goal:** The observer's clause-(iii) body-model composite V_BM is established as a genuinely DIFFERENT object from h_3(O)'s BGW Jordan-monoidal non-composability -- rigorously and non-circularly, so the RESTRICTION claim does not presuppose its own conclusion. The derivation workspace (`claim.md`, `STATE.md`) is initialized.

**Depends on:** Nothing within v15.0 (entry point). Reads Paper 5 Def 1, lem:bottleneck + rem:converse, BGW 2020, Hanche-Olsen; carries v6.0/v8.0/v11.0 context.
**Requirements:** DERV-60-01, DERV-60-02, DERV-60-03, DERV-60-04, DERV-00-01 (Phase 60 slice)

**Contract Coverage:**
- Advances: claim-two-composites; initializes deliv-two-composites, claim.md, derivation STATE.md
- Deliverables: `derivations/p5-basin-restriction/{claim.md, STATE.md}`; precise definitions of BOTH composite notions; the independence argument
- Anchor coverage: ref-paper5-def1 (clause iii = minimal composite), ref-bgw (universe-tensoring h_3(O) fails; minimal=maximal for M_n(C)^sa), ref-hanche-olsen (well-behaved composites); confirm rem:converse against BGW
- Prior inputs: milestone prompt step 1; the Paper 5 remark (main.tex ~line 393) that Def 1 characterizes COMPOSABLE self-modelers and that the non-composable h_3(O) case is treated separately -- direct textual support for the distinction
- Forbidden proxies: fp-conflate-composites ("h_3(O) non-composable => observer has no composite"); citing rem:converse as if already in the live paper

**Success Criteria** (what must be TRUE):

1. Both composite notions are stated precisely and independently: (a) V_BM = the observer's MINIMAL composite OUS carrying product states, product effects, non-signaling constraints, and a product-form sequential product (Paper 5 Def 1 clause iii); (b) the BGW Jordan-monoidal composite of the universe algebra h_3(O) with another system. Each is defined in its own terms, citing Paper 5 Def 1, BGW 2020, Hanche-Olsen.
2. It is PROVED that h_3(O)'s BGW non-composability and the existence of the observer's V_BM are LOGICALLY INDEPENDENT statements about DIFFERENT objects -- non-composability of h_3(O) does not entail non-existence of V_BM. The argument explicitly does not smuggle in the conclusion (no circularity: the distinction is earned, not assumed).
3. rem:converse is confirmed against BGW: every M_n(C)^sa admits a faithful self-model (V_M = V_B = M_n(C)^sa, phi = id, composite M_{n^2}(C)^sa), and for complex matrix algebras minimal and maximal composites COINCIDE, so clause (iii) is auto-satisfied. The exact BGW statement grounding "minimal = maximal for M_n(C)^sa" is located, and it is flagged that rem:converse is not yet a labeled remark in the live complexification.tex.
4. `derivations/p5-basin-restriction/claim.md` (RESTRICTION restated in the derivation's own notation, with allowed inputs and the three prohibited reward-hacking moves stated explicitly) and `derivations/p5-basin-restriction/STATE.md` (derivation-tree state) exist.
...
**Goal:** The C*-bottleneck slice A = h_3(C_u) ~ M_3(C)^sa is verified to satisfy all four clauses of Paper 5 Definition 1 as a self-modeler in its own right -- with clause (iii) checked AS STATED (not redefined), rem:converse supplying (ii)-(iii), and explicit SymPy validation of the projective-unit and simplicity structure.

**Depends on:** Phase 60 (two-composites distinction earned; rem:converse confirmed against BGW)
**Requirements:** DERV-61-01, DERV-61-02, DERV-61-03, VALD-61-01, DERV-00-01 (Phase 61 slice)

**Contract Coverage:**
- Advances: claim-slice-clause-iii; deliv-slice-clause-iii
- Deliverables: clause-by-clause verification (i)-(iv); rem:converse instantiation for M_3(C)^sa; SymPy/matrix check (VALD-61-01)
- Anchor coverage: ref-paper5-def1 (the four clauses, clause iii NOT redefined), ref-lem-bottleneck (slice A = h_3(C_u) ~ M_3(C)^sa, single F_4-orbit, rank-1 Peirce-0 = h_2(C_u))
- Prior inputs: rem:converse (from Phase 60); standard M_3(C)^sa structure; v8.0/v11.0 octonion/h_3(O) SymPy infrastructure (reuse)
- Forbidden proxies: fp-redefine-iii (weakening clause iii so it is trivially satisfied); "the slice is M_3(C)^sa so clause iii is automatic" without checking the embedding is induced by E (that check is Phase 62's job, not a shortcut here); "looks right" without explicit projective-unit / simplicity check
...
**Goal:** Determine -- by demonstration on the ACTUAL non-associative h_3(O) structure, not by assertion -- whether the Peirce/bottleneck conditional expectation E: h_3(O) -> h_3(C_u) TRANSPORTS the self-modeling sequential product coherently from the ambient: does E(sqrt(X) Y sqrt(X)) = sqrt(EX)(EY)sqrt(EX) for GENERIC ambient X, Y in h_3(O) (sqrt(X) computed in the ambient; non-associativity load-bearing)? The outcome is EITHER coherent ambient E-transport (a RESTRICTION embedding lemma) OR a precisely-located ambient-transport obstruction -- which is the EXPECTED, ACCEPTABLE result and REFINES (does NOT refute) RESTRICTION. **CORRECTED FRAMING (2026-05-24, Bryan's decision):** the prompt over-specified RESTRICTION. RESTRICTION needs only **coexistence-as-island** -- the observer is a self-certified M_3(C)^sa system on the slice (Phase 61, all four clauses verbatim) and the slice sits inside h_3(O) as the range of the projection E. It does NOT need the observer's structure transported/derived from the ambient via E. An ambient-transport obstruction REFINES the through-line to "self-contained C* island," it does NOT establish "independent posits." This is the load-bearing phase, where any (now-expected) ambient-transport obstruction lives. **SLICE-INTERNAL TRIVIALITY (documented control, not the decisive test):** the slice A = h_3(C_u) is a CLOSED, ASSOCIATIVE Jordan subalgebra (= range E); for a, b in A, sqrt(a) b sqrt(a) stays in A with leakage EXACTLY 0 and triple associator EXACTLY 0 -- the SP datum is induced TRIVIALLY on the slice and non-associativity is NOT engaged there. The decisive question is therefore AMBIENT E-transport, not slice-internal.

**Depends on:** Phase 61 (slice satisfies all four Def 1 clauses)
**Requirements:** DERV-62-01, DERV-62-02, DERV-62-03, VALD-62-01, DERV-00-01 (Phase 62 slice)

**Contract Coverage:**
- Advances: claim-restriction (the decisive, deepest-unproven join); deliv-embedding
- Deliverables: explicit setup of E (positive, unital, range = JB-subalgebra, Effros-Stormer); explicit treatment of the sequential product under E; demonstration on the real non-associative h_3(O) (SymPy); preservation proof OR precise obstruction
- Anchor coverage: ref-effros-stormer (E onto h_3(C_u) is a positive unital idempotent; range is a JB-subalgebra), ref-lem-bottleneck (the bottleneck E and its Peirce structure), ref-hanche-olsen (induced vs imported composite)
- Prior inputs: V_1 = R bottleneck (v6.0/v8.0 -- Peirce interface to V_{1/2} is scalar); the sequential product a&b = sqrt(a) b sqrt(a) via CFC square roots in the non-associative ambient; v8.0/v11.0 octonion/h_3(O) SymPy infrastructure (reuse). NOTE: the v11.0 result (sqrt(T_a) T_b sqrt(T_a) exits M_16(R)) is a DIFFERENT mechanism (Clifford non-commuting pairs, not the slice/projection restriction) and is NOT carried as a prior that the ambient E-transport test "leans toward obstruction" -- drop that prior (plan-checker warning).
- Forbidden proxies: fp-assert-preservation (asserting E transports the sequential product coherently WITHOUT computing E(sqrt(X) Y sqrt(X)) vs sqrt(EX)(EY)sqrt(EX) on the actual non-associative h_3(O) for GENERIC ambient X,Y); hand-waving "E preserves everything"; ignoring non-associativity; the line-loophole of running a non-associativity exerciser on UNRELATED matrices while the decisive test is the trivial slice-internal one; fp-redefine-iii (clause iii itself is NEVER weakened -- only RESTRICTION's EMBEDDING clause is weakened to coexistence-as-island); fp-conflate-composites (V_BM stays the observer's OWN internal composite A (x) A, never transported from / identified with the ambient h_3(O)).
- **OBSTRUCTION-OR-PRESERVATION FORK (flagged; verdict semantics CORRECTED):** this phase resolves to ONE of two outcomes on the AMBIENT E-transport question -- (P) E transports the sequential product coherently (R = E(sqrt(X) Y sqrt(X)) - sqrt(EX)(EY)sqrt(EX) = 0 exact) -> a RESTRICTION embedding lemma; or (O) E does NOT (R != 0 exact) -> an ambient-transport obstruction, the EXPECTED, ACCEPTABLE outcome, characterized precisely (the structure E cannot transport + the minimal extra input). EITHER way the verdict REFINES RESTRICTION: (O) means the observer is a self-contained C* ISLAND on the slice (not transported from the non-composable whole) -- the through-line SURVIVES (basin h_3(O) -> maximal C* slice M_3(C)^sa -> Paper 5 certifies QM; E = access/projection map, NOT required to be a Jordan morphism). (O) does NOT establish "independent posits / two unconnected foundations."
- **NON-ASSOCIATIVITY REWARD-HACKING GUARD (flagged; now SATISFIABLE):** success REQUIRES the decisive object to be the AMBIENT transport residual E(sqrt(X) Y sqrt(X)) - sqrt(EX)(EY)sqrt(EX) for GENERIC X,Y in h_3(O), where sqrt(X) is computed in the ambient and non-associativity is genuinely engaged ((xy)z != x(yz); verify the associator of the relevant triple is nonzero on the chosen X,Y). A demonstration that only manipulates the slice-internal sqrt(a) b sqrt(a) (a,b in A -- trivial: closed associative subalgebra, leakage 0) does NOT satisfy any decisive criterion below (it is the documented CONTROL only). E is NOT a Jordan morphism on ambient elements (E(X o X) vs (EX) o (EX) differ), so the ambient transport question is genuinely non-trivial.

**Success Criteria** (what must be TRUE):

1. The Peirce/bottleneck conditional expectation E: h_3(O) -> h_3(C_u) is set up explicitly (Effros-Stormer): positive, unital, idempotent, range = JB-subalgebra. What E preserves is stated precisely -- in particular whether E is coherent with the SEQUENTIAL product a&b = sqrt(a) b sqrt(a), not only the Jordan product a o b.
2. Whether E TRANSPORTS the self-modeling sequential product coherently from the ambient is settled by computation ON THE ACTUAL NON-ASSOCIATIVE STRUCTURE -- the AMBIENT transport residual R = E(sqrt(X) Y sqrt(X)) - sqrt(EX)(EY)sqrt(EX) is computed for GENERIC X, Y in h_3(O) (sqrt(X) via CFC/Jordan spectral calculus in the ambient; non-associativity genuinely engaged -- the associator of the relevant triple is verified nonzero), NOT asserted. The slice-internal case (a,b in A) is recorded as a documented CONTROL with leakage 0 / associator 0 (the SP datum is induced trivially on the closed associative slice; non-associativity not engaged there).
3. The verdict for this step is decisive and falls on the OBSTRUCTION-OR-PRESERVATION fork on the AMBIENT transport question: EITHER (P) E transports coherently (R = 0 exact) and a RESTRICTION embedding lemma is stated and proved (touching the actual non-associative structure), OR (O) E does NOT (R != 0 exact) -- the EXPECTED, ACCEPTABLE outcome -- and the ambient-transport obstruction is characterized precisely (the exact structure E cannot transport from the non-associative ambient + the minimal extra input). EITHER outcome REFINES RESTRICTION: (O) -> observer is a self-contained C* ISLAND on the slice (coexistence-as-island), the through-line survives, E is the access/projection map (not a Jordan morphism); it does NOT mean independent posits.
4. SymPy/matrix verification on h_3(O) (VALD-62-01) constructs E onto h_3(C_u) for a fixed u in S^6 (e.g. u = e_7, per the convention lock) and tests the AMBIENT transport residual R = E(sqrt(X) Y sqrt(X)) - sqrt(EX)(EY)sqrt(EX) for GENERIC ambient X (PSD, so sqrt(X) exists), Y in h_3(O), computed in the ambient with non-associativity genuinely engaged (associator-nonzero check): R = 0 exact => coherent transport (P); R != 0 exact => ambient-transport obstruction (O, expected/acceptable). ALSO includes the slice-internal control (a,b in A: leakage 0, associator 0) clearly separated as a documented triviality. EXACT arithmetic (zero-tolerance); explicit octonion/h_3(O) matrices (v8.0/v11.0 infrastructure ported to exact SymPy). NOTE: pytest is NOT in the executor venv (sympy/numpy only) -- use an assert-based __main__ harness (code/slice_clause_iii_verification.py _report/ALL_PASS/sys.exit pattern), runnable as `python tests/test_embedding_under_E.py`.

**Backtracking trigger (CORRECTED -- ambient-transport obstruction is EXPECTED, not a collapse):** An ambient-transport obstruction (R != 0: E does not transport the sequential product coherently) is the EXPECTED result and a DELIVERABLE -- it REFINES RESTRICTION to coexistence-as-island (the observer is a self-contained C* island on the slice; the through-line survives; E is the access/projection map, not a Jordan morphism). It is NOT a program-collapse PAUSE and does NOT establish independent posits. Do NOT force preservation; record the obstruction precisely. Only a genuinely unexpected pathology (e.g. the slice-internal control fails, or the ambient test cannot be made non-associative) is a true backtracking trigger.

**Plans:** 3 plans

Plans:

- [ ] 62-01-PLAN.md (wave 1) -- Set up E: h_3(O) -> h_3(C_u) explicitly (entrywise C_u-projection; positive, unital, idempotent; range = JB-subalgebra by Effros-Stormer; Jordan-product-preserving embedding; Peirce decomposition at E_11). State PRECISELY what E preserves (the Jordan product a o b on the slice) and FRAME the decisive crux as AMBIENT E-transport: whether E(sqrt(X) Y sqrt(X)) = sqrt(EX)(EY)sqrt(EX) for GENERIC ambient X,Y (non-associativity load-bearing; E is NOT a Jordan morphism on ambient elements). Record the slice-internal triviality plainly (closed associative subalgebra; SP datum induced trivially; non-associativity not engaged). State the CORRECTED RESTRICTION (coexistence-as-island) and weakened embedding clause; drop the v11.0-leans-toward-O prior (different mechanism). Creates derivations/p5-basin-restriction/embedding-under-E.md §1-§3. (DERV-62-01)
- [ ] 62-02-PLAN.md (wave 2, depends 62-01) -- DECISIVE COMPUTATION (TDD, exact SymPy, assert-based __main__ harness -- NO pytest). Build E onto h_3(C_u) exactly; compute the AMBIENT transport residual R = E(sqrt(X) Y sqrt(X)) - sqrt(EX)(EY)sqrt(EX) for GENERIC X (PSD),Y in h_3(O) with sqrt(X) by ambient Jordan/CFC spectral calculus and the relevant associator verified nonzero (R==0 => coherent transport P; R!=0 => ambient-transport obstruction O, EXPECTED/acceptable); independent Peirce-grade cross-check; slice-internal CONTROL (a,b in A: leakage 0, associator 0) clearly separated; zero-tolerance EXACT arithmetic. Verdict not forced. code/embedding_under_E_verification.py + tests/test_embedding_under_E.py (runnable as `python tests/test_embedding_under_E.py`) + §4. (DERV-62-02, VALD-62-01)
- [ ] 62-03-PLAN.md (wave 3, depends 62-01, 62-02, interactive) -- VERDICT on the fork, read off 62-02's exact ambient residual, INTERPRETED as "refinement either way": (P) RESTRICTION embedding lemma (E transports coherently) OR (O, expected) ambient-transport obstruction -> observer is a self-contained C* ISLAND on the slice (coexistence-as-island); through-line SURVIVES (E = access/projection map, not a Jordan morphism); consistent with U-B-M (Peirce != tensor; basin fixes TYPE); NOT independent posits. Updates derivations/p5-basin-restriction/claim.md (weaken RESTRICTION's EMBEDDING clause to coexistence-as-island + correct verdict semantics + correct PAUSE condition 2; clause iii itself unchanged), STATE.md, appends attempt-04.md (DERV-00-01); interactive checkpoint surfaces the verdict. Milestone verdict left to Phase 63. (DERV-62-03, DERV-00-01)

### Phase 63: Verdict

> **FRAMING NOTE (carry into Phase 63 planning; Bryan 2026-05-24, Phase 62 correction):** Phase 62 reframed RESTRICTION to **coexistence-as-island** (the observer self-models on the slice per Phase 61 and the slice sits inside h_3(O) as the range of E; ambient E-transport of the sequential product is a STRONGER, NOT-REQUIRED property). Consequently an ambient-transport obstruction REFINES RESTRICTION (self-contained C* island; through-line survives), it does NOT establish "independent posits / two unconnected foundations". The Phase 63 verdict semantics below ("obstruction => independent posits") are PRE-CORRECTION and STALE; reconcile them with the corrected coexistence-as-island framing (claim.md, ROADMAP Phase 62, embedding-under-E.md §5) when Phase 63 is planned. Phase 62's actual (P/O) verdict feeds this.

**Goal:** A decisive verdict is delivered -- either a clean RESTRICTION theorem (the "self-modeling -> QM -> h_3(O)" through-line is real, in the strongest form where E transports the sequential product) or a precisely-characterized ambient-transport obstruction (which REFINES RESTRICTION to coexistence-as-island -- self-contained C* island, through-line survives -- NOT "independent posits"; see the FRAMING NOTE above) -- with the explicit consequence for the Radical Relativity program, and the reward-hacking guards confirmed by adversarial fresh-eyes review.

**Depends on:** Phase 62 (preservation proof OR characterized obstruction)
**Requirements:** DERV-63-01, DERV-63-02, DERV-00-02, DERV-00-01 (Phase 63 slice)

**Contract Coverage:**
- Advances: obs-verdict; claim-restriction (final adjudication); deliv-verdict
- Deliverables: `derivations/p5-basin-restriction/RESULT.md` (theorem-or-obstruction + program consequence); adversarial guard review; the one-sentence verdict line (DERV-00-02)
- Anchor coverage: the whole contract; all phase outputs (60-62); all 5 anchors as cited upstream
- Prior inputs: Phase 60 distinction, Phase 61 clause verification, Phase 62 embedding verdict; the milestone's stop/rethink conditions
- Forbidden proxies: fp-force-positive (forcing a positive RESTRICTION theorem when the honest outcome is an obstruction); vague "mostly works" / "broadly preserved" verdicts; any verdict not touching the actual non-associative structure
- **NEGATIVE-RESULT-IS-SUCCESS (flagged):** a clean, precisely-characterized obstruction is a FULLY ACCEPTABLE pass. The acceptance test passes on EITHER a theorem-with-proof OR a precise obstruction + program consequence. Reporting a negative honestly is the success condition; manufacturing a positive is failure.

**Success Criteria** (what must be TRUE):

1. `derivations/p5-basin-restriction/RESULT.md` is assembled with a DECISIVE verdict: EITHER a clean RESTRICTION theorem (statement + proof, touching the actual non-associative structure) OR a precisely-characterized obstruction, plus the explicit consequence for the program (through-line real vs C and O independent posits) and -- if an obstruction -- what would have to change to close it.
2. An adversarial fresh-eyes review of the verdict is performed BEFORE RESULT.md finalizes, checking the three reward-hacking guards: (a) clause (iii) was NOT redefined; (b) the two composites were NOT conflated; (c) preservation was NOT asserted without demonstration on h_3(O). The review confirms a negative result (if reached) was reported honestly rather than a positive forced.
3. The final verdict line (DERV-00-02) states one of: RESTRICTION THEOREM (through-line) or CHARACTERIZED OBSTRUCTION (independent posits), with the one-sentence consequence for the Radical Relativity program.
4. The `attempt-NN.md` log (DERV-00-01) is complete: one entry per serious proof/obstruction attempt across Phases 60-63, each stating inputs used, the argument, and failure mode if any.
...
**Execution Order:** 60 -> 61 -> 62 -> 63 (strictly sequential)
