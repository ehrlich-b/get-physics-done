...
physical premise. The lattice topology $G = (V, E)$ is input. The
Wilsonian continuum limit is standard physics. No additional physical
...
L2 & Lattice Hamiltonian $H = \sum J\,\swapop$ forced by $U(n)$ covariance
   & Derived & \ref{sec:lattice} & This work & Lattice topology (input) \\
...
L6 & Wilsonian continuum limit
   & Standard physics & \ref{sec:einstein} & Standard & L2 \\
...
The novel contribution of this work is Links~L1--L5: a specific UV
completion---the self-modeling lattice forced by the algebraic structure
of quantum theory~\cite{Paper5}---that satisfies the three inputs of
Jacobson's entanglement equilibrium argument~\cite{Jacobson2016}. Links
L6--L8 follow Jacobson's derivation, with L7 reframed from an assumption
to a definitional identification.
