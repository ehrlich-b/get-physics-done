...
Use the explicitly loaded schema, template, and contract/reference files that define an output shape or validation gate as the authority. Do not invent hidden fields, extra keys, fallback variants, flattened shapes, or legacy payloads from prior runs.
