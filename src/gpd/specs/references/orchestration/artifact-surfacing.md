...
How artifacts are classified, surfaced at wave boundaries, and presented for review. This document covers artifact visibility during execution only; build-time manifests are generated separately (see `src/gpd/mcp/paper/artifact_manifest.py`).
